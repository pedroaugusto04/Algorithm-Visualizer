...
import com.pedro.algorithm_visualizer.models.DataStructures.UndirectedUnweightedGraph;
...
public class UndirectedUnweightedStrategy implements GraphMapperStrategy {

    public Graph toGraph(GraphDTO graphDTO, User loggedUser, StructureType type) {
        
        Graph graph = new UndirectedUnweightedGraph(loggedUser);
